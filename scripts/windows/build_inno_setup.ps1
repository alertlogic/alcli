...
$name = "SignTool0";
$value = "signtool=C:\Program Files (x86)\Windows Kits\10\bin\x64\signtool.exe sign /a /t http://timestamp.fabrikam.com/scripts/timstamper.dll /sm /s My /n `"Alert Logic`" `$f";
